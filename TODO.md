...
- [ ] The Penny full suite remains not fully green: `602 passed, 2 skipped, 1 failed`; the remaining failure is the pre-existing malformed RFC3339 timestamp contract test (`TranscriptContractTests.test_checked_maya_schema_uses_full_json_schema_and_format_validation`).
- [ ] Continue observing the repaired backlog; the reported live queue at `2026-09-18T19:31 PDT` was 55 completed, 22 pending, and 1 processing. The episode interrupted during restart completed durably with 2 review markers.
